...
import requests
# import sys, datetime, json, requests
# import argparse, sys, socket, threading, json
from smartie.smartie import Smartie

print(Smartie)

raw_response = requests.get('http://localhost:4000/api/info/status')
# response = requests.get('http://localhost:4000/api/info/metadata')
